...
public class OrderServiceImplTest {
    ...
    public void findList() {
        ...
        IPage<OrderDTO> orderDTOPage = orderService.findList(orderMasterPage, "");
        Assert.assertNotEquals(0, orderDTOPage.getTotal());
    }
...
//        Assert.assertNotEquals(0,orderDTOPage.getTotalElements());
        Assert.assertTrue("查询所有的订单列表", orderDTOPage.getTotal() > 0);
